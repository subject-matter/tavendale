<html>
<head>
<title>Payment Failed | Tavendale and Partners</title>
<meta type="description" cotnent="Tavendale and Partners" />
...
<div class="white-container">
    ...
    <div class="form-container">
        ...
        <header>
            <img src="/payments/img/tp-logo.png" alt="Tavendale and Partners Logo" />
            <a href="https://www.tp.co.nz">BACK TO HOME PAGE</a>
        </header>

        <div class="content">
            <h1>Payment Failed</h1>
            <p>Your payment has failed. Please check your details and try again.</p>
            <a href="/payments/" class="return-button">Back to secure payment page</a>
            <a href="https://www.tp.co.nz" class="return-button button-margin">Back to home page</a>
        </div>
