    ...
    <div class="form-container">
        ...
        <div class="form">
            ...
            <div class="form-row">
                ...
                <table>
                    <tr>
                        <td>Invoice total:</td> <td class="align-right">$<span id="invoice_total">0.00</span></td>
                    </tr>
                    <tr>
                        <td>Credit card fee:</td> <td class="align-right"> $<span id="card_fee">0.00</span></td>
                    </tr>
                    <tr>
                        <td><strong>Total due:</strong></td> <td class="align-right"> <strong>$<span id="total_fees">0.00</span></strong></td>
                    </tr>
                </table>
